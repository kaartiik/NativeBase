...
var ScrollableTabView = (0, _createReactClass2.default)({
  ...
  updateSceneKeys: function updateSceneKeys(_ref) {
    var page = _ref.page,
      ...
      children =
        _ref$children === undefined ? this.props.children : _ref$children,
  ...
  newSceneKeys: function newSceneKeys(_ref2) {
    ...
    var _ref2$previousKeys = _ref2.previousKeys,
      ...
      children =
        _ref2$children === undefined ? this.props.children : _ref2$children;
    var newKeys = [];
  ...
  render: function render() {
    ...
    if (overlayTabs) {
      ...
      tabBarProps.style =
        ((_tabBarProps$style = { position: 'absolute', left: 0, right: 0 }),
        _defineProperty(
          _tabBarProps$style,
